...
Check out this git repo into your workspace.
    ...
    git clone https://github.com/tormach/tormach_za src/tormach_za

Install the `vcs` tool if needed.

    sudo apt-get install python3-vcstool

Pull source dependencies into your workspace.

    vcs import src < src/tormach_za/za.repos.yaml

Install any missing package dependencies.

    rosdep install --from-paths src/tormach_za --ignore-src
